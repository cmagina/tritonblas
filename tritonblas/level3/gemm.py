...
def gemm_kernel(
    ...
    # and accumulate
    # `a_block` is a block of [BLOCK_SIZE_M, BLOCK_SIZE_K] pointers
    # `b_block` is a block of [BLOCK_SIZE_K, BLOCK_SIZE_N] pointers
